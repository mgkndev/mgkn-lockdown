...
A lightweight UE4SS-based script for Lockdown Protocol. Gives you server-validated item giving, heal, and ammo features when playing as host.
...
- The **signed UE4SS** build for Lockdown Protocol — download from Nexus Mods (link shared separately)
...
1. Extract the UE4SS zip you downloaded from Nexus.
